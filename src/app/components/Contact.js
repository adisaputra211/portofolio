                ...
                <div className={styles.content}>
                    ...
                    <div className={`${styles.infoPanel} animate-on-scroll delay-1`}>
                        ...
                        <div className={styles.socials}>
                            <a href="https://github.com/saputraaa211?tab=repositories" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="GitHub">
                            ...
                            <a href="https://www.linkedin.com/in/nur-cahyo-adi-saputra/" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="LinkedIn">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
